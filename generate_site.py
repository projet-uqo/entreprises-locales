...
<form id="entrepriseForm">
    ...
    <div class="form-group">
        ...
        <input 
            ...
            title="2 à 80 caractères. Lettres, chiffres, espaces et ponctuation simple."
        >
    </div>
    ...
    <div class="form-group">
        ...
        <input 
            ...
            required
            maxlength="60"
            pattern="[A-Za-zÀ-ÿ0-9 ,.'-]{2,60}"
            title="2 à 60 caractères. Lettres, chiffres, espaces et ponctuation simple."
        >
    </div>
    ...
    <div class="form-group">
        ...
        <textarea 
            ...
            rows="4"
            maxlength="500"
            placeholder="Décrivez brièvement l'entreprise (max 500 caractères)"
        ></textarea>
    </div>
